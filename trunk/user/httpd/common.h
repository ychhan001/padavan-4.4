...
#define EVM_RESTART_ARIA		(1ULL << 40)
//#define EVM_RESTART_SCUT		(1ULL << 43)
#define EVM_RESTART_TTYD		(1ULL << 41)
#define EVM_RESTART_VLMCSD		(1ULL << 42)
...
#define EVM_RESTART_ALIDDNS		    (1ULL << 43)
#define EVM_RESTART_FRP		    (1ULL << 44)
#define EVM_RESTART_SMARTDNS		    (1ULL << 45)
#define EVM_RESTART_ADGUARDHOME		    (1ULL << 46)
#define EVM_RESTART_CADDY			(1ULL << 47)
#define EVM_RESTART_ZEROTIER		    (1ULL << 48)
//#define EVM_RESTART_ALDRIVER		    (1ULL << 52)
#define EVM_RESTART_WIREGUARD		    (1ULL << 49)
#define EVM_RESTART_VNTS		(1ULL << 50)
#define EVM_RESTART_VNTCLI		(1ULL << 51)
#define EVM_RESTART_ALIST		(1ULL << 52)
#define EVM_RESTART_CLOUDFLARE		(1ULL << 53)
#define EVM_RESTART_SQM		    (1ULL << 54)

#define EVM_RESTART_REBOOT		(1ULL << 55)

#define EVM_BLOCK_UNSAFE		(1ULL << 56) /* special case */
