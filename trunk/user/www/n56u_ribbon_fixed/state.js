...
if (found_app_vnts()){
	tabtitle[20] = new Array("", "VNT服务器");
}
if (found_app_vntcli()){
	tabtitle[21] = new Array("", "VNT客户端");
}
if (found_app_alist()){
	tabtitle[22] = new Array("", "Alist");
}
if (found_app_cloudflare()){
	tabtitle[23] = new Array("", "CF域名解析");
}
